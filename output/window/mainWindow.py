...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.textEdit_folder.setGeometry(QtCore.QRect(100, 25, 651, 31))
        self.textEdit_folder.setObjectName("textEdit_folder")
        self.label_folder = QtWidgets.QLabel(self.centralwidget)
        self.label_folder.setGeometry(QtCore.QRect(10, 30, 91, 17))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.textEdit_folder.setStatusTip(_translate("MainWindow", "Folder path field"))
        self.label_folder.setText(_translate("MainWindow", "Folder path"))
