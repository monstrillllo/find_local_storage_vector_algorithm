...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.textEdit_search.setGeometry(QtCore.QRect(100, 40, 611, 31))
        self.textEdit_search.setObjectName("textEdit_search")
        self.label_search = QtWidgets.QLabel(self.centralwidget)
        self.label_search.setGeometry(QtCore.QRect(10, 40, 91, 17))
        ...
        self.btn_choose_folder.setGeometry(QtCore.QRect(720, 25, 31, 71))
        self.btn_choose_folder.setText("")
        icon1 = QtGui.QIcon()
        icon1.addPixmap(QtGui.QPixmap("icons/folder.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.btn_choose_folder.setIcon(icon1)
